...
Для продолжения работы с модулем Айтида iMark необходимо использовать версию, не ниже 2.0.1, которая требует наличия лицензии на подписку: «Айтида Release Pack 1 год для сервера» либо «S565 Айтида Release Pack 1 год для РМК/iMark».
