...
>	- **ЭДО ИД**
>	- **Юридический адрес**, включая код и название региона расположения
>	- **Для ИП поле ФИО**.
...
>	- **Фактический адрес заполняется в карточке склада отправителя товара**.
...
> ![](/images/marking/edi/3946956f053ac092da1784146bea14a2.png)
{.is-info}
