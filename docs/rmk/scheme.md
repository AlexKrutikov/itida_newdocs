...
Тип чека **Прочие отчеты** является особым типом чека, не предназначенным для печати на ККТ. Он используется для, например, печати ценников или других отчетов на рабочем месте кассира. Либо для формирования таких документов, как Инвентаризация ТМЦ, которые не требуют печати на ККТ, но могут быть необходимы для формирования соответствующих документов из данных кассы.
